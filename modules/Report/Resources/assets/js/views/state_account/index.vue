                ...
                <div class="card-body">
                    <data-table :applyCustomer="true" :resource="resource" :visibleColumns="columns">
                        <tr slot="heading">
                            ...
                            <th v-if="columns.guides.visible" class="text-end">Guia</th>
                            <th v-if="columns.options.visible" class="text-end">Opciones</th>
                            <th>Cliente</th>
                            <th>Productos</th>
                            <th>Estado</th>
                            <th>Moneda</th>
                        ...
                        <tr slot-scope="{ index, row }">
                            ...
                            <td v-if="columns.options.visible" class="text-center">
                                <button class="btn waves-effect waves-light btn-sm btn-info m-1__2" type="button"
