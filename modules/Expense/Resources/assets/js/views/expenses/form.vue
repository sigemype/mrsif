                    ...
                    <div class="row">
                         <div class="col-lg-4">
                            <div class="form-group" :class="{'has-danger': errors.expense_type_id}">
                                ...
                                <small class="text-danger" v-if="errors.expense_type_id" v-text="errors.expense_type_id[0]"></small>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group" :class="{'has-danger': errors.supplier_id}">
                                ...
                                <small class="text-danger" v-if="errors.supplier_id" v-text="errors.supplier_id[0]"></small>
                            </div>
                        </div>
...
<a href="#" v-if="!addMotivo" @click.prevent="addMotivo = true">[+ Nuevo]</a>
<a href="#" v-if="addMotivo" @click.prevent="saveMotivo">[Guardar]</a>

                                </label>
                                <el-select
                                v-if="!addMotivo"
                                 v-model="form.expense_reason_id" filterable >
                                ...
                                <small class="text-danger" v-if="errors.expense_reason_id" v-text="errors.expense_reason_id[0]"></small>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async saveMotivo(){
                //expense-reasons
                const response = await this.$http.post(`/expense-reasons`, {description:this.motivo})
