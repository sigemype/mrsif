                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.total_pen}">
                                ...
                                <small class="text-danger" v-if="errors.total_pen" v-text="errors.total_pen[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.igv_pen}">
                                ...
                                <small class="text-danger" v-if="errors.igv_pen" v-text="errors.igv_pen[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.subtotal_pen}">
                                ...
                                <small class="text-danger" v-if="errors.subtotal_pen" v-text="errors.subtotal_pen[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4 mt-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.total_usd}">
                                ...
                                <small class="text-danger" v-if="errors.total_usd" v-text="errors.total_usd[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4 mt-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.igv_usd}">
                                ...
                                <small class="text-danger" v-if="errors.igv_usd" v-text="errors.igv_usd[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-4 mt-4">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.subtotal_usd}">
                                ...
                                <small class="text-danger" v-if="errors.subtotal_usd" v-text="errors.subtotal_usd[0]"></small>
                            </div>
                        </div>
                </div>
