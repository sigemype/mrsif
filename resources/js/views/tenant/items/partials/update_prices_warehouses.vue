                ...
                <div class="row">
                    <div class="col-12 form-group" :class="{'has-danger': errors.file}">
                        <el-upload
                                ref="upload"
                                :headers="headers"
                                action="/items/import/items-update-prices-warehouses"
                                :show-file-list="true"
                                :auto-upload="false"
                                :multiple="false"
                    ...
                    <div class="col-12 mt-4 mb-2">
                        <a class="text-dark mr-auto" href="/items/formats/items-update-prices-warehouses" target="_new">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                this.titleDialog = 'Actualizar precio de los productos por almacén'
            },
            async submit() {
