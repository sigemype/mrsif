                    ...
                    <div class="col-xl-12">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div v-if="typeUser == 'admin'" class="col-md-3">
                                ...
                                <div class="col-md-12" style="margin-top:29px">
                                    ...
                                    <el-button
                                      ...
                                      <el-button
                                        ...
                                        class="submit"
                                        type="danger"
                                        @click.prevent="clickDownload('pdf_h')"
                                        >
                                        <i class="fa fa-file-pdf"></i> Exportar PDF Horizontal
                                    </el-button>
                                </div>
                                <div class="col-md-1 mt-5 text-end">
                                </div>
                                ...
                                <div class="col-md-12 table-responsive" >
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th>Número</th>
                                            <th>Cliente</th>
                                            <th v-if="columns.trade_name.visible">Nombre comercial</th>
                                            <th v-if="columns.internal_code.visible">Código interno</th>
                                            <th>Usuario</th>
                                            ...
                                            <th class="text-end">T. Nota Crédito</th>
                                        ...
                                        <tbody>
                                            <template v-for="(row, index) in records">
                                                <tr v-if="row.total_to_pay > 0" :key="index">
                                                    ...
                                                    <td v-if="columns.trade_name.visible">{{ row.customer_trade_name }}</td>
                                                    <td v-if="columns.internal_code.visible">{{ row.customer_internal_code }}</td>
                                                    <td>{{ row.username }}</td>
