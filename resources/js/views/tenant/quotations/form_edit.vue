                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-left mt-3 mb-0">
                            <address class="ib mr-2">
                                <template v-if="form.quotations_optional!=null && form.quotations_optional_value!=null"> 
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.delivery_date}">
                                    ...
                                    <small class="text-danger" v-if="errors.delivery_date"
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center font-weight-bold">Valor U.</th>
                                            <th class="text-center font-weight-bold">Precio U.</th>
