...
<!--                        Sección -->
                    <td>{{ row.section }} </td>
                        ...
                        <td v-if="columns.total_exportation.visible"
                            class="text-end">{{ row.total_exportation }}
                        </td>
                        <! -- -- >
                        <td v-if="columns.total_free.visible"
                            class="text-end">{{ row.total_free }}
                        </td>
                        <! -- -- >
                        <td v-if="columns.total_unaffected.visible"
                            class="text-end">{{ row.total_unaffected }}
                        </td>
                        <! -- T.Exonerado - ->
                        <td v-if="columns.total_exonerated.visible"
                            class="text-end">{{ row.total_exonerated }}
                        </td>

                        <!-- -- >
                        <td v-if="columns.total_taxed.visible"
                            class="text-end">{{ row.total_taxed }}
                        </td>
                        <!-- - ->
                        <td v-if="columns.total_igv.visible"
                            class="text-end">{{ row.total_igv }}
                        </td>
                        <!-- Total -->
                    ...
                    -->
                        <td class="text-end">
                            ...
                            <button
                                ...
                                class="btn waves-effect waves-light btn-sm btn-inverse"
                                data-placement="top"
                                data-toggle="tooltip"
