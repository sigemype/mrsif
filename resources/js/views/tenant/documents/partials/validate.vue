                        ...
                        for (let index = 0; index < response.data.archivo_txt; index++) {
                                ...
                                await  this.$http.get(`/reports/validate-documents/validateDocumentstxt?numero=`+index).then((response) => {
                                    ...
                                    if (error.response.status === 504) {
                                        this.$alert('<b>Se agoto el tiempo de espera de respuesta a webservices de sunat</b>', 'Validacion Comprobantes Electronicos',{
                                        dangerouslyUseHTMLString: true,    
                                        confirmButtonText: 'Aceptar',
                                        })
                                        //return this.$message.error("Se agoto el tiempo de espera de respuesta a webservices de sunat");
                                    }
