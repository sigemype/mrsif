                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div
                                    :class="{
                                        'has-danger': errors.quantity_period
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label">
                        ...
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody
                                                v-if="
                                                    fakeForm.items !==
                                                        undefined &&
                                                        fakeForm.items.length >
                                                            0
                                                "
                                            >
                                                <tr
                                                    v-for="(row,
                                                    index) in fakeForm.items"
                                                    :key="index"
                                                >
                                                    <td>{{ index + 1 }}</td>
                                                    <td>
                                ...
                                <div class="col-xlg-push-6 col-6 text-end">
                                    <p
                                        v-if="fakeForm.total_exportation > 0"
                                        class="text-end"
                                    >
                                        OP.EXPORTACIÓN:
                                        {{ currency_type.symbol }}
                                        {{ fakeForm.total_exportation }}
                                    </p>
                                    <p
                                        v-if="fakeForm.total_free > 0"
                                        class="text-end"
                                    >
                                        OP.GRATUITAS:
                                        {{ currency_type.symbol }}
                                    ...
                                    <p
                                        v-if="fakeForm.total_unaffected > 0"
                                        class="text-end"
                                    >
                                        OP.INAFECTAS:
                                        {{ currency_type.symbol }}
                                        {{ fakeForm.total_unaffected }}
                                    </p>
                                    <p
                                        v-if="fakeForm.total_exonerated > 0"
                                        class="text-end"
                                    >
                                        OP.EXONERADAS:
                                        {{ currency_type.symbol }}
                                        {{ fakeForm.total_exonerated }}
                                    </p>
                                    <p
                                        v-if="fakeForm.total_taxed > 0"
                                        class="text-end"
                                    >
                                        OP.GRAVADA: {{ currency_type.symbol }}
                                        {{ fakeForm.total_taxed }}
                                    </p>
                                    <p
                                        v-if="fakeForm.total_igv > 0"
                                        class="text-end"
                                    >
...
export default {
    ...
    methods: {
        ...mapActions(["loadConfiguration", "clearFormData", "EmitEvent"]),

        getCommonData() {
            this.$http
                .post("/suscription/CommonData", {})
                .then(response => {
                    this.$store.commit(
                        "setCurrencyTypes",
        ...
        submit() {
            ...
            // console.dir(data)
            this.$http
                .post(`/suscription/${this.resource}`, data)
                .then(response => {
        ...
        changeCurrencyType() {
            ...
            this.form_data.items.forEach(row => {
                items.push(
                    calculateRowItem(
                        row,
                        this.form_data.currency_type_id,
                        this.form_data.exchange_rate_sale,
        ...
        setTotalDefaultPayment() {
            if (
                this.fakeForm.payments !== undefined &&
                this.fakeForm.payments.length > 0
            ) {
