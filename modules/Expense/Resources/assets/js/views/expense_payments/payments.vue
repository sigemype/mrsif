                    ...
                    <div class="table-responsive">
                        <table class="table">
                                ...
                                <template v-else>
                                    ...
                                    <td>
                                        <div class="form-group mb-0" :class="{'has-danger': row.errors.expense_method_type_id}">
                                            ...
                                            <small class="text-danger" v-if="row.errors.expense_method_type_id" v-text="row.errors.expense_method_type_id[0]"></small>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <tr>
                                ...
                                <td class="text-end">{{ expense.total_paid }}</td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-end">{{ expense.total_difference }}</td>
                                <td></td>
                            </tr>
                            </tfoot>
                        </table>
