                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group" :class="{'has-danger': errors.series}">
                                ...
                                <small class="text-danger" v-if="errors.series"
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-2 float-right">
                                        <div class="form-group" :class="{'has-danger': errors.perception_number}">
                                            ...
                                            <small class="text-danger" v-if="errors.perception_number" v-text="errors.perception_number[0]"></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-2 float-right">
                                        <div class="form-group" :class="{'has-danger': errors.perception_date}">
                                            ...
                                            <small class="text-danger" v-if="errors.perception_date" v-text="errors.perception_date[0]"></small>
                                        </div>
                                    </div>
                                </div>
