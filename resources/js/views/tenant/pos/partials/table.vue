    ...
    <div>
        ...
        >
            ...
            <el-table-column label="Stock">
                <template slot-scope="{ row }">
                    <!-- <button type="button" class="btn btn-sm btn-primary-pos" @click="clickWarehouseDetail(row)">
            ...
            <el-table-column label="Historial ventas">
                <template slot-scope="{ row }">
                    <button
                        type="button"
                        class="btn btn-sm btn-primary-pos text-dark"
            ...
            <!-- <el-table-column label="Historial compras">
                    <template slot-scope="{row}">
                        <button type="button" class="btn btn-sm btn-primary-pos" @click="clickHistoryPurchases(row.item_id)"><i class="fas fa-cart-plus"></i></button>
                    </template>
                </el-table-column> -->
        </el-table>
...
export default {
    ...
    methods: {
        ...
        enterdblclick(row, column, cell, event){
