                        ...
                        <td>
                            ...
                            >
                                <el-table :data="row.warehouses">
                                    <el-table-column
                                        :style="{ width: 220 }"
                                        property="warehouse_description"
                                        label="Almacén"
                                    ></el-table-column>
                                    <el-table-column
                                        :style="{ width: 90 }"
                        ...
                        <td class="text-center">
                            ...
                            >
                                <el-button
                                    type="success"
                                    @click.prevent="
                                        clickDownloadFormatSunat(row.id)
                                    "
                                    size="small"
                            ...
                            >
                                <el-button
                                    type="danger"
                                    @click.prevent="
                                        clickDownloadFormatSunatPdf(row.id)
                                    "
                                    size="small"
...
export default {
    ...
    methods: {
        ...
        clickDownloadFormatSunatPdf(item_id) {
            this.$eventHub.$emit("exportFormatSunatPdf", item_id);
        },
    },
};
</script>
