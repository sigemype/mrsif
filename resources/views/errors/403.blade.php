            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-error">
                        ...
                        <p class="error-explanation text-center text-e"><strong>Acceso denegado:</strong> Su cuenta esta inactiva, usted tiene compromisos pendientes de pago, comuníquese con el administrador.</p>
                    </div>
                </div> 
            </div>
        </div>
