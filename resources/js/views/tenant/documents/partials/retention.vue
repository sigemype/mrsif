            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group" :class="{'has-danger': errors.voucher_date_of_issue}">
                        ...
                        <small class="text-danger" v-if="errors.voucher_date_of_issue"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-0" :class="{'has-danger': errors.voucher_number}">
                        ...
                        <small class="text-danger" v-if="errors.voucher_number"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-0" :class="{'has-danger': errors.voucher_amount}">
                        ...
                        <small class="text-danger" v-if="errors.voucher_amount"
