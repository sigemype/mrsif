                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.fixed_asset_item_id}">
                            ...
                            <small class="text-danger" v-if="errors.fixed_asset_item_id" v-text="errors.fixed_asset_item_id[0]"></small>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{'has-danger': errors.unit_price}">
                            ...
                            <small class="text-danger" v-if="errors.unit_price" v-text="errors.unit_price[0]"></small>
                        </div>
                    </div>
