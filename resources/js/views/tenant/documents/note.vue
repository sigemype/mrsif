                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <template v-if="form.document_type_id === '08'">
                                <div class="form-group" :class="{'has-danger': errors['note.note_debit_type_id']}">
                                    ...
                                    <small class="text-danger" v-if="errors['note.note_debit_type_id']"
                            ...
                            <template v-else>
                                <div class="form-group" :class="{'has-danger': errors['note.note_credit_type_id']}">
                                    ...
                                    <small class="text-danger" v-if="errors['note.note_credit_type_id']"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group" :class="{'has-danger': errors['note.note_description']}">
                                ...
                                <small class="text-danger" v-if="errors['note.note_description']"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group" :class="{'has-danger': errors.purchase_order}">
                                ...
                                <small class="text-danger" v-if="errors.purchase_order"
                    ...
                    <div class="row" v-if="form.items.length > 0">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-end" v-if="form.total_igv > 0">IGV: {{ currency_type.symbol }}
                                {{ form.total_igv }}</p>
                            <p class="text-end" v-if="form.total_isc > 0">ISC: {{ currency_type.symbol }}
                                {{ form.total_isc }}</p>
                            <p class="text-end" v-if="form.total_charge > 0">OTROS CARGOS: {{ currency_type.symbol }}
                                {{ form.total_charge }}</p>

                            <template v-if="isCreditNoteAndType13 || isCreditNoteAndType03">
                                <h3 class="text-end"><b>TOTAL A PAGAR: </b>{{ currency_type.symbol }} {{ form.total }}
                                </h3>
                            </template>
                            <template v-else>
