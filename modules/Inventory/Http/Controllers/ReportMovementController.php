...
class ReportMovementController extends Controller
{
    ...
    private function getRecords($request)
    {
        ...
        return Inventory::whereFilterReportMovement(
            $warehouse_id,
    ...
    private function getDataForFormat($request)
    {
        ...
        return [
            ...
            'records' => $this->getRecords($request->all())->get()->transform(function ($row, $key) {
    ...
    */
    ...
    private function getDataForFormatStock($request)
    {
        return [
            ...
            'records' => $this->getStockRecords($request->all())->get()->transform(function ($row, $key) {
