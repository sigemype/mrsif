                ...
                <div class="row mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group" :class="{'has-danger': errors.date_start}">
                                ...
                                <small class="text-danger" v-if="errors.date_start" v-text="errors.date_start[0]"></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group" :class="{'has-danger': errors.date_end}">
                                ...
                                <el-date-picker v-model="form.date_end" type="date"
                                                ...
                                                value-format="yyyy-MM-dd" format="dd/MM/yyyy" :clearable="true"></el-date-picker>
                                <small class="text-danger" v-if="errors.date_end" v-text="errors.date_end[0]"></small>
                            </div>
                        </div>
