            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 pb-2">
                        <el-button-group>
                            ...
                            <el-button  type="primary" size="mini" @click="onFilterByStatus('DISPONIBLE')">
                                DISPONIBLE
                            </el-button>
                            <el-button   type="danger" size="mini" @click="onFilterByStatus('OCUPADO')">
                                OCUPADO
                            </el-button>
                            <el-button   type="success" size="mini" @click="onFilterByStatus('LIMPIEZA')">
                                LIMPIEZA
                            </el-button>
                            <el-button size="mini"   type="warning" @click="onFilterByStatus('MANTENIMIENTO')">
                                MANTENIMIENTO
                            </el-button>
                        </el-button-group>
                    </div>
                ...
                <hr />
                  <div class="row d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-md-4 col-lg-3 col-6 mb-3" v-for="(ro,index) in items" :key="index">
                        <div class="card text-white" :class="{
                                    'bg-primary': ro.status === 'DISPONIBLE',
                                    'bg-warning': ro.status === 'MANTENIMIENTO',
                                    'bg-danger': ro.status === 'OCUPADO',
                                    'bg-success': ro.status === 'LIMPIEZA',
                                }">
                          <div class="card-header">
                            <div class="row justify-content-between p-0">
                                ...
                                <template v-else-if="ro.status === 'OCUPADO'">
                          ...
                          <div class="card-body text-center">
                            <template v-if="ro.status === 'DISPONIBLE'">
                                <i class="fa fa-bed fa-2x mt-2 text-white"></i>
                                <span class="h3 ml-3 text-white">{{ ro.name }}</span>
                            </template>
                            <template v-else-if="ro.status === 'OCUPADO'">
                                <i class="fa fa-user-tie fa-2x  text-white"></i>
                                    <span class="h6 ml-3 text-white">{{
                                        ro.rent.customer.name
                                    }}</span>
                            </template>
                            <template v-else>
                                <i class="fa fa-bed fa-2x mt-2 text-white"></i>
                            ...
                            <div class="card-footer text-center">{{ ro.status }}</div>
    ...
    */
    methods: {
        ...
        onFinalizeClean(room) {
            const text = `Está a punto de terminar la limpieza de la habitación ${
                room.name
            }`;
