            ...
            <table class="">
                ...
                ?>
                    <tr>
                        ...
                        <td class="celda">{{$itemKardex['date_time']}}</td>
                         <td class="celda">{{$itemKardex['type_transaction']}}</td>
                         <td class="celda">{{$itemKardex['number']}}</td>
                        <td class="celda">{{$itemKardex['sale_note_asoc']}}</td>
                        ...
                        <td class="celda">
                            @if ($itemKardex['input']>0)
                            {{$itemKardex['input']}}
                            @endif
                        </td>
                        <td class="celda">
                        @if (isset($itemKardex['purchase_cost'])&& $itemKardex['purchase_cost']>0)
                            {{$itemKardex['purchase_cost']}}
                        @endif
                        </td>
                        <td class="celda">
                        @if (isset($itemKardex['total_purchase_cost'])&&$itemKardex['total_purchase_cost']>0)
                            {{$itemKardex['total_purchase_cost']}}
                        @endif
                        </td>
                        <td class="celda"> 
                            {{$itemKardex['output']}}
                        ...
                        <td class="celda"> 
                            {{isset($itemKardex['sales_cost']) && $itemKardex['sales_cost']}}
                        </td>
                        <td class="celda"> 
                            {{isset($itemKardex['total_sales']) && $itemKardex['total_sales']}}
                        </td>
                        <td class="celda"> 
                            {{isset($itemKardex['quantity_balance'])}}
                        </td>
                        <td class="celda"> 
                            {{isset($itemKardex['price_balance'])}}
                        </td>
                        <td class="celda"> 
                            {{isset($itemKardex['total_balance'])}}
                        </td>
