                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" :class="{'has-danger': errors.password_confirmation}">
                                ...
                                <small class="text-danger" v-if="errors.password_confirmation" v-text="errors.password_confirmation[0]"></small>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <!-- <div class="col-md-6">
                            ...
                            <div :class="{'has-danger': errors.enable_whatsapp}">
                                ...
                                <small class="text-danger" v-if="errors.enable_whatsapp" v-text="errors.enable_whatsapp[0]"></small>
                                <br>
                                <small class="text-danger">Se mostrará un icono de Whatsapp en cada cliente.</small>
                            </div>
                        </div> -->
                    </div>
                </div>
