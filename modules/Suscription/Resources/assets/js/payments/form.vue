                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr v-for="(row, index) in form.items"
                                                ...
                                                <!--<td class="text-end">{{  getSymbol(currency_type) }} {{ row.total_charge }}</td>-->
                                                <td class="text-end">{{ getSymbol(currency_type) }} {{
                                                        row.total
                                                                       }}
                                                </td>
        ...
        changeCurrencyType() {
            ...
            if (this.form !== undefined &&
                ...
                Object.keys(citems).forEach(key => {
                    ...
                    items.push(calculateRowItem(row, this.form.currency_type_id, this.form.exchange_rate_sale, this.percentage_igv||0.18))
                })
            }
