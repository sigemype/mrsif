                    ...
                    <template v-if="form.send_document_to_pse">
                        ...
                        <!-- <div class="col-md-3 mt-3">
                            <div class="form-group" :class="{'has-danger': errors.client_id_pse}">
                                ...
                                <small class="text-danger" v-if="errors.client_id_pse" v-text="errors.client_id_pse[0]"></small>
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group" :class="{'has-danger': errors.url_login_pse}">
                                ...
                                <small class="text-danger" v-if="errors.url_login_pse" v-text="errors.url_login_pse[0]"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group" :class="{'has-danger': errors.user_pse}">
                                ...
                                <small class="text-danger" v-if="errors.user_pse" v-text="errors.user_pse[0]"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group" :class="{'has-danger': errors.password_pse}">
                                ...
                                <small class="text-danger" v-if="errors.password_pse" v-text="errors.password_pse[0]"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group" :class="{'has-danger': errors.url_signature_pse}">
                                ...
                                <small class="text-danger" v-if="errors.url_signature_pse" v-text="errors.url_signature_pse[0]"></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="form-group" :class="{'has-danger': errors.url_send_cdr_pse}">
                                ...
                                <small class="text-danger" v-if="errors.url_send_cdr_pse" v-text="errors.url_send_cdr_pse[0]"></small>
                            </div>
                        </div>
                    </template>
