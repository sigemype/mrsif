                    ...
                    <div class="form-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.delivery_date}">
                                    ...
                                    <small class="text-danger" v-if="errors.delivery_date" v-text="errors.delivery_date[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <small class="text-danger" v-if="errors.shipping_address"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.exchange_rate_sale}">
                                    ...
                                    <small class="text-danger" v-if="errors.exchange_rate_sale" v-text="errors.exchange_rate_sale[0]"></small>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group" :class="{'has-danger': errors.observation}">
                                    ...
                                    <small class="text-danger" v-if="errors.observation"
                                                ...
                                                <div class="form-group mb-2 mr-2">
                                                    ...
                                                    <template v-if="errors[`additional_data.${index}.title`]">
                                                        <div class="form-group" :class="{'has-danger': errors[`additional_data.${index}.title`]}">
                                                            <small class="text-danger" v-text="errors[`additional_data.${index}.title`][0]"></small>
                                                        </div>
                                                    </template>
                                                </div>
                                            </td>
                                                ...
                                                <div class="form-group mb-2 mr-2">
                                                    ...
                                                    <template v-if="errors[`additional_data.${index}.description`]">
                                                        <div class="form-group" :class="{'has-danger': errors[`additional_data.${index}.description`]}">
                                                            <small class="text-danger" v-text="errors[`additional_data.${index}.description`][0]"></small>
                                                        </div>
                                                    </template>
                                                </div>
                                            </td>
                                            <td class="series-table-actions text-center">
                                                <button  type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteAdditionalData(index)">
                        ...
                        <div class="row mt-2">
                                            ...
                                            <tr v-for="(row, index) in form.items">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <template v-if="row.id">
                                                        <button type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteONItem(row.id, index)">x</button>
                                                    </template>
                                                    <template v-else-if="row.record_id">
                                                        <button type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteONItem(row.record_id, index)">x</button>
                                                    </template>
                                                    <template v-else>
                            ...
                            <div class="col-md-4">
                                ...
                                <h3 class="text-end" v-if="form.total > 0"><b>TOTAL A PAGAR: </b>{{ currency_type.symbol }} {{ form.total }}</h3>
                            </div>
