...
class Nav {
  ...
  _onPinClick(event) {
      var valorBehaviour = this.html.getAttribute('data-behaviour');
      this.html.setAttribute('data-behaviour',valorBehaviour === 'unpinned' ? 'pinned' : 'unpinned');
   // localStorage.setItem('acorn-medical-assistant-behaviour', valorBehaviour === 'unpinned' ? 'pinned' : 'unpinned');
      const element = document.querySelector('main');
      // if(valorBehaviour == 'unpinned'){
      //  element.classList.remove("animated_unpinned");
      //  element.classList.add('animated_pinned');
      // }else{
      //   element.classList.remove("animated_pinned");
      //   element.classList.add('animated_unpinned');
      // }
      const animationClassToRemove = valorBehaviour == 'unpinned' ? 'animated_pinned' : 'animated_unpinned';
      const animationClassToAdd = valorBehaviour == 'unpinned' ? 'animated_unpinned' : 'animated_pinned';      
      element.classList.remove(animationClassToRemove);
      element.classList.add(animationClassToAdd);
