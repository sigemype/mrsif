                ...
                <div class="row">
                    <div class="col-12 form-group" :class="{'has-danger': errors.file}">
                        <el-upload
                                ref="upload"
                                :headers="headers"
                                action="/items/import/items-update-prices-person-type"
                                :show-file-list="true"
                                :auto-upload="false"
                                :multiple="false"
                        ...
                        <small class="text-danger" v-if="errors.file" v-text="errors.file[0]"></small>
                    </div>
                    <div class="col-12 mt-4 mb-2">
                        <a class="text-dark mr-auto" href="/items/formats/items-update-prices-person-type" target="_new">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                this.titleDialog = 'Actualizar precio de los productos por tipo de cliente'
            },
            async submit() {
