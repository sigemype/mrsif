                                ...
                                <tr>
                                    ...
                                    <th class="text-end">
                                        <button class="btn waves-effect waves-light btn-primary"
                                                type="button"
                                                @click.prevent="addItemDialog">+ Agregar Producto
                                        </button>
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tr v-for="(row, index) in form.items" :key="index">
                                    ...
                                    <td class="text-end">
                                          <button class="btn waves-effect waves-light btn-sm btn-info"
                                                type="button"
                                                @click.prevent="clickEditItem(index)">🖊️
                                        </button>
...
export default {
  ...
  async  created() {
    ...
    methods: { setItemFromResponse(item, itemsParsed) {
        ...
        addItem(form) {
            ...
            console.log("🚀 ~ file: create.vue:1093 ~ addItem ~ this.form.items:", this.form.items)
            let attributes = null
            if (it.attributes) {
