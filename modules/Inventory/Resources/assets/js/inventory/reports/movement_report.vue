            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.movement_type }"
                        >
                            ...
                            <small
                                class="text-danger"
                                v-if="errors.movement_type"
                                v-text="errors.movement_type[0]"
                            ></small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <el-checkbox
                                class="mt-4"
                                v-model="form.order_inventory_transaction_id"
                                >Ordenar por motivo de traslado</el-checkbox
                            >
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        changeMovementType() {
            ...
            this.inventory_transactions = _.filter(
                this.all_inventory_transactions,
                { type: this.form.movement_type }
            );
        },
        initForm() {
            this.errors = {};
        ...
        async searchRemoteItems(search) {
            ...
            await this.$http
                .post(`/inventory/search_items`, { search: search })
                .then((response) => {
        ...
        downloadPdfGuide(guide_id) {
            if (guide_id) {
                window.open(
                    `/reports/kardex/get_pdf_guide/${guide_id}`,
                    "_blank"
                );
            }
        },
