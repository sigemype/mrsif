                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.is_client}">
                                ...
                                <small class="text-danger" v-if="errors.is_client" v-text="errors.is_client[0]"></small>
                            </div>
                        </div> 
                </div>
                <div class="row mt-4" v-if="form.is_client">
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group" :class="{'has-danger': errors.url_server}">
                            ...
                            <small class="text-danger" v-if="errors.url_server" v-text="errors.url_server[0]"></small>
                        </div>
                    </div>
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group" :class="{'has-danger': errors.token_server}">
                            ...
                            <small class="text-danger" v-if="errors.token_server" v-text="errors.token_server[0]"></small>
                        </div>
                    </div> 
                </div>
