...
export default {
    ...
    methods: {
        exportFormatSunat(item_id){
            ...
            window.open(`/${this.resource}/pdf-format-sunat/?${query}`, '_blank')
  ...
  this.$eventHub.$on('exportFormatSunatPdf', (item_id) => {
                this.exportFormatSunatPdf(item_id)
            })
