            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <small v-if="errors.lot_code" class="text-danger" v-text="errors.lot_code[0]"></small>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <small v-if="errors.date_of_due" class="text-danger" v-text="errors.date_of_due[0]"></small>
                    </div>
                </div>
            </div>
