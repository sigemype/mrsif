                ...
                <div class="row mt-3" v-if="form.filter_by_variants">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" :class="{'has-danger': errors.item_size_id}">
                            ...
                            <small class="text-danger" v-if="errors.item_size_id" v-text="errors.item_size_id[0]"></small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" :class="{'has-danger': errors.item_color_id}">
                            ...
                            <small class="text-danger" v-if="errors.item_color_id" v-text="errors.item_color_id[0]"></small>
                        </div>
                    </div>
                </div>
