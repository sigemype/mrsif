...
<body>
    ...
    <div style="margin-top:20px; margin-bottom:15px;">
        <table>
            <tr>
                <td colspan="8">
                    <p><b>FORMATO 13.1: "REGISTRO DE INVENTARIO PERMANENTE VALORIZADO - DETALLE DEL INVENTARIO
                            VALORIZADO" </b></p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    {{ $additionalData['unit_type_table_six']['code'] }} -
        ...
        <table>
            <tr>
                <td colspan="4" align="center">
                    <p><b>DOCUMENTO DE TRASLADO, COMPROBANTE DE PAGO, DOCUMENTO DE TRASLADO, COMPROBANTE DE PAGO,
                            DOCUMENTO INTERNO O SIMILAR</b></p>
                </td>
            ...
            <tr>
                ...
                <td>
                    {{ checkKey($last_input, 'input_quantity', 0) }}
                </td>
                <td>
                    {{ checkKey($last_input, 'input_unit_price', 0) }}
                </td>
                <td>
                    {{ checkKey($last_input, 'input_total', 0) }}
                </td>
                <td>
                    {{ checkKey($last_output, 'output_quantity', 0) }}
                </td>
                <td>
                    {{ checkKey($last_output, 'output_unit_price', 0) }}
                </td>
                <td>
                    {{ checkKey($last_output, 'output_total', 0) }}
                </td>
                <td>
                    {{ checkKey($last_row, 'balance_quantity', 0) }}
                </td>
                <td>
                    {{ checkKey($last_row, 'balance_unit_cost', 0) }}
                </td>
                <td>
                    {{ checkKey($last_row, 'balance_total_cost', 0) }}
                </td>
            </tr>
            {{-- <tr>
                <td colspan="5" align="right">
