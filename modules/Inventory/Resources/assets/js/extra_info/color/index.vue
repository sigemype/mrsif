<template>
    <div>
        ...
        <color-form :resource="resource"> </color-form>
    </div>
</template>
<style scoped>
.anulate_color {
...
export default {
    ...
    methods: {
        ...
        clickDownload(external_id) {
            window.open(
                `${this.resource}/download/${external_id}/a4`,
                "_blank"
            );
        },
        EditItem(id) {
        ...
        getRecords() {
            ...
            return this.$http
                .get(
                    `./${this.resource}/records?page=${this.pagination.current_page}`
                )
                .then((response) => {
                    ...
                    let pag = { ...data };
                    this.pagination = pag;
                    this.pagination.per_page = parseInt(data.per_page);
