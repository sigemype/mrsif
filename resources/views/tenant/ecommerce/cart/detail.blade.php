...
<div class="row" id="app">
            ...
            <table class="table table-cart">
                ...
                <tbody>
                    <tr v-for="(row, index) in records" class="product-row">
                        ...
                        <td>
                            <input class="vertical-quantity form-control input_quantity" :data-product="row.id" type="text">
                        </td>
                        <td>@{{ row.sub_total }}</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4" class="clearfix">
                            ...
                            <div class="float-right">
                                <a href="#" @click="clearShoppingCart" class="btn btn-outline-secondary btn-clear-cart">Limpiar Carrito</a>
    ...
    <div class="col-lg-4">
        <div class="cart-summary">
            ...
            <div class="checkout-methods text-center">
                ...
                <a href="{{route('tenant_ecommerce_login')}}" class="btn btn-block btn-sm btn-primary login-link">Pagar
                    con EFECTIVO</a>
                <a style="margin-left:15%" href="{{route('tenant_ecommerce_login')}}" class="btn btn-block btn-sm login-link">
                ...
                <div v-show="payment_cash.clicked" style="margin: 3%" class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input readonly placeholder="0.0" v-model="payment_cash.amount" type="text" onkeypress="return isNumberKey(event)" maxlength="14" class="form-control" aria-label="Amount">
                        <button @click="paymentCash" class="btn btn-success">OK!</button>
                    </div>
                </div>

                <form class="btn btn-block btn-sm " action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                    ...
                    <input type="image" src="https://simple-membership-plugin.com/wp-content/uploads/2018/09/paypal-smart-payment-button-for-simple-membership.jpg" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
    ...
    <div class="modal fade" id="modal_ask_document" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal fade" id="modal_identity_document" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <select class="form-control" :disabled="formIdentity.identity_document_type_id == '6'" v-model="formIdentity.identity_document_type_id">
                                <option v-for="option in identity_document_types" :value="option.id" :label="option.description"></option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" v-model="formIdentity.number" :maxlength="maxLength" aria-label="Recipient's username" aria-describedby="button-addon2">
                                <div class="input-group-append">

                                    <button :disabled="!formIdentity.number" @click.prevent="searchCustomer" class="btn btn-outline-secondary" type="button" id="button-addon2">
                    ...
                    <div v-show="response_search.message" class="alert" :class="{'alert-danger' : !response_search.success, 'alert-success': response_search.success}" role="alert">
                        @{{ response_search.message }}
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCELAR</button>
                    <button type="button" class="btn btn-primary" @click="sendDocument" v-show="formIdentity.validate">ENVIAR</button>
                </div>
            </div>
        </div>
    </div>
        ...
        methods: {
            ...
            getDataFinally(document) {
                return {
                    ...
                    product: 'Compras Ecommerce Facturador Smart',
