                        ...
                        <table class="table">
                            ...
                            <tr v-for="(row, index) in records" :key="index">
                                <template v-if="row.id">
                                    ...
                                    <td>{{ row.reference }}</td>
                                    <td class="text-end">{{ row.person_dispatch }}</td>
                                    <td class="series-table-actions text-end">
                                        <button type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDelete(row.id)" v-if="typeUser === 'admin'">
                                ...
                                <template v-else>
                                    ...
                                    <td>
                                        <div class="form-group mb-0" :class="{'has-danger': row.errors.person_dispatch}">
                                            ...
                                            <small class="text-danger" v-if="row.errors.person_dispatch" v-text="row.errors.person_dispatch[0]"></small>
                                        </div>
                                    </td>
                                    <td>
                ...
                <!-- <div class="col-md-12 pt-2">
                    <div class="d-flex">
                        <div class="d-flex">
                            ...
                            <button v-if="typeUser != 'seller'" type="button" class="btn waves-effect waves-light btn-sm btn-light" @click.prevent="statusUpdate('initial')">Borrar Check</button>
                        </div>
