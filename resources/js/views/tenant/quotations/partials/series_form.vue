                                    ...
                                    <tr v-for="(row, index) in items" :key="index">
                                        ...
                                        <td class="series-table-actions text-end">
                                            ...
                                            <template v-if="row.item.lots_enabled">
                                                <button class="btn waves-effect waves-light btn-sm btn-primary" @click.prevent="openDialogLotsGroup(index, row)">
                                                    <i class="el-icon-check"></i> Lotes
                                                </button>
                                            </template>

                                            <button  type="button" class="btn waves-effect waves-light btn-sm btn-success" @click.prevent="openDialogLots(row.item.lots, row.item_id)">
                                                    <i class="el-icon-check"></i> Series
                                            </button>
                                            <button  type="button" class="btn waves-effect waves-light btn-sm btn-info" @click.prevent="openSelectWarehouses(row, index)">
