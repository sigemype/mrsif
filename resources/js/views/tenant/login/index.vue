          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <small class="text-danger" v-if="errors.position_form" v-text="errors.position_form[0]"></small>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <small class="text-danger" v-if="errors.position_logo" v-text="errors.position_logo[0]"></small>
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="form-group">
